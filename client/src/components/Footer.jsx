    ...
    <footer className={`footer ${isExpanded ? 'expanded' : 'collapsed'}`}>
      ...
      <div className="footer-container">
        <div className="footer-section">
          <h3>About Us</h3>
          <p>Your one-stop shop for custom stickers and decals. High-quality, durable, and customizable designs for all your needs.</p>
        </div>
        ...
        <div className="footer-section">
          <h3>Contact Us</h3>
          <p>Email: info@amaraacreations.com</p>
      ...
      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} Amaara Creations. All rights reserved.</p>
      </div>
    </footer>
  );
};
